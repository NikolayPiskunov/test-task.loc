...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Подтвердите свой аккаунт Email</div>
                ...
                <div class="card-body">
                    ...
                    <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                        @csrf
                        <button type="submit" class="btn btn-link p-0 m-0 align-baseline">нажмите здесь, чтобы повторно отправить подтверждение на почту</button>.
                    </form>
                </div>
            </div>
        </div>
